...
int llama_bootstrap(const char *model_path, void* state_pr, int32_t n_ctx, int memory_type_int)
    // load the model
    {
        ...
        if (!llama_model_load(model_path, state->model, state->vocab, n_ctx, memory_type)) {
